...
import img from '../../src/assets/Azeem_Full.jpg'
...
export default function Home() {
  ...
  return (
    <div className='bg-black text-white text-center py-16' id="home">
      ...
      <button className="mt-4 cursor-pointer bg-gradient-to-r from-orange-500 to-yellow-500 text-white hidden md:inline transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full" onClick={e=>utils['contactMe'](e,setIsModalOpen)} id="">Contact Me</button>
